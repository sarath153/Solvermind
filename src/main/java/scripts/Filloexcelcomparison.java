...
public class Filloexcelcomparison {
	...
	public static void main(String[] args) throws FilloException {
		try {
			...
			Connection connection1 = fillo.getConnection("C:\\Users\\RBT\\Documents\\mas.xlsx");
			Connection connection2 = fillo.getConnection("C:\\Users\\RBT\\Documents\\act.xlsx");
					...
					if (stowageSheet1 != null
						...
						for (String columnName : columnsToCompare) {
							...
							if ((valueSheet1Column == null && valueSheet2Column == null)
								...
								// Extent_fail2(test, "Values are not matched for " + "Stowage number : " +
								// stowageSheet1 + "||" + "Column name is :" + columnName + "||" + " Master
								// value: " + valueSheet1Column + "||" + " Test value: " + valueSheet2Column);
