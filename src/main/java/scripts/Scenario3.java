...
public class Scenario3 extends Keywords {
	...
	public void Semiautorun3(WebDriver driver, String vessel2,ExtentTest test ,ExtentTest testDetail,String detailreportPath) throws Exception {
		...
		String Finalresultpath = System.getProperty("user.dir") + "/Uploads/Scenario3/Resultexcel"+NewTime+".xlsx";
		String path = NewTime;
		...
		if (flag == true) {
			takescreenshot1(driver, "/Expected_screenshot/Scenario3/Bay1");
			}
		...
		// Master container data ...
				...
				// important
				String filePath_M = System.getProperty("user.dir") + "\\uploads\\Scenario3\\ContainerPoolData\\MasterData_"
						+ path + ".xlsx";
		...
		String Master = System.getProperty("user.dir") + "\\Uploads\\Scenario3\\MasterFiles\\Masterfile_" + path + ".xlsx";
...
//		click(driver, Lashing);
		...
		sendKeys(driver,Saveinput , "TD Testplan Scenario3 "+NewTime);
		...
		// Test container data ...
				...
				// important
				String filePath_T = System.getProperty("user.dir") + "\\uploads\\Scenario3\\ContainerPoolData\\TestData_"
						+ path + ".xlsx";
		...
		String Test = System.getProperty("user.dir") + "\\Uploads\\Scenario3\\TestFiles\\Testfile_" + path + ".xlsx";
