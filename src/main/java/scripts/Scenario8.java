...
public class Scenario8 extends Keywords {
	...
	public void Semiautorun8(WebDriver driver, String vessel2,ExtentTest test ,ExtentTest testDetail,String detailreportPath) throws Exception {
		...
		String Finalresultpath = System.getProperty("user.dir") + "/Uploads/Scenario8/Resultexcel" + NewTime + ".xlsx";
		String path = NewTime;
...
//		driver.findElement(By.xpath("//*[@id='demo-simple-select-autowidth']")).click();
		...
		if (flag = true) {
			takescreenshot1(driver, "/Expected_screenshot/Scenario8/Bay1");
		}
...
//Screenshot from MAster Plan file
		...
		// Master container data ...
				...
				// important
				String filePath_M = System.getProperty("user.dir") + "\\uploads\\Scenario8\\ContainerPoolData\\MasterData_"
						+ path + ".xlsx";
		...
		String Master = System.getProperty("user.dir") + "\\Uploads\\Scenario8\\MasterFiles\\Masterfile_" + path + ".xlsx";
...
//		click(driver, Lashing);
		...
		sendKeys(driver, Saveinput, "TD Testplan Scenario8 "+NewTime);
		...
		// Test container data ...
				...
				// important
				String filePath_T = System.getProperty("user.dir") + "\\uploads\\Scenario8\\ContainerPoolData\\TestData_"
						+ path + ".xlsx";
		...
		String Test = System.getProperty("user.dir") + "\\Uploads\\Scenario8\\TestFiles\\Testfile_" + path + ".xlsx";
